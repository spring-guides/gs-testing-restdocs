...
use {mock-mvc}[Spring's `MockMvc`] and ask for it to be injected for you by using the
{web-mvc-test}[`@WebMvcTest` annotation] on the test case. The following example (from
